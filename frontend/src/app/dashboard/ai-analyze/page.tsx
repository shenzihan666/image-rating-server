...
import { aiAnalyzeApi, type AIModel, type ApiError } from "@/lib/api";
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-[#333333]/60">
            Switch between local and remote analyzers, and configure pluggable
            providers like Qwen3-VL.
          </p>
        </div>
              ...
              <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#333333]/8">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {model.is_loaded && (
                      <span className="inline-flex items-center rounded-full bg-[#333333]/8 px-3 py-1 text-xs font-medium text-[#333333]/70">
                        Loaded
                      </span>
                    )}
                  </div>
